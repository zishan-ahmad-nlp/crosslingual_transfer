...
for test_number in range(5):
    for i in range(len(strings)):
        ...
        log_file = 'logs/tl_semeval_not_crosslingual_embedding_' +string+'_'+str(test_number)+'.txt' 
        print("log file: %s" %(log_file))
        weights_file='weights/tl_semeval_not_crosslingual_embedding_'+string+'_'+str(test_number)+'.h5'
        ...
        load_weights_file = 'weights/pretrain_semeval_bilstm_3cnn.h5'
        nb_sequence_length = nb_sequence_length
        nb_embedding_dims= nb_embedding_dims
