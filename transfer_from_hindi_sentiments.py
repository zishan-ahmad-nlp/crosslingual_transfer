...
train_file = 'Data/train_total.txt'
weights_file ='weights/without_pretraining.h5'
log_file = 'logs/without_pretraining.txt'
batch_size = 16
...
for test_number in range(5):
    for i in range(len(strings)):
        ...
        log_file = 'logs/tl_hindi_sentiments_' +string+'_'+str(test_number)+'.txt' 
        print("log file: %s" %(log_file))
        weights_file='weights/tl_hindi_sentiments_'+string+'_'+str(test_number)+'.h5'
        ...
        load_weights_file = 'weights/pretrain_bilstm_3cnn_dropout=0.5.h5'
        nb_sequence_length = nb_sequence_length
        nb_embedding_dims= nb_embedding_dims
        check_for_generator=3
